...
variants={fadeInUp}
>
<nav className="max-w-7xl mx-auto flex items-center justify-between px-2 md:px-4 py-4 md:py-6">{/* Logo */}
...
<span className="bg-gradient-to-r from-yellow-400 via-yellow-300 to-yellow-500 bg-clip-text text-transparent block">Discover the Quantum Energy Breakthrough</span>
...
For thousands worldwide, <span className="text-yellow-400 font-bold">Quantum Energy</span> has been the turning point — restoring vitality, promoting healing, and empowering people to live healthier, stronger, and more fulfilled lives.
</p>
{/* Video Embed */}
...
<li className="flex items-center"><span className="mr-3 text-yellow-500">❤️</span> Improved intimacy &amp; vitality (through Quantum Boxers)</li>
</ul>
...
<p className="text-base text-gray-300 font-semibold mb-4 italic leading-relaxed">&quot;Quantum Energy has been a game changer for my focus and productivity. I used to rely on coffee and painkillers to get through my workday, but now I feel clear-headed and energized from morning till night. My migraines are gone, and I&apos;m more present with my family. I recommend this to anyone who wants to break free from dependency and thrive naturally.&quot;</p>
<div className="mt-auto flex items-center gap-3">
...
<div className="font-bold mb-2 text-lg text-yellow-400">&quot;Quantum Energy gave me my life back.&quot;</div>
...
<div className="text-gray-300 text-sm">Tunde explains how Quantum Energy tools ended years of headaches.</div>
</div>
</a>
...
<div className="text-gray-300 text-sm">Ada describes the transformation in her home after using Quantum Boxers.</div>
</div>
</a>
...
<div className="text-gray-300 text-sm">Ngozi shares her journey from doubt to real results with Quantum Energy.</div>
</div>
</a>
...
<li className="flex items-center"><span className="mr-3 text-yellow-400">⚡</span> A chance to explore Quantum Energy tools that work</li>
</ul>
</div>
</div>
</motion.section>
