...
// Product ID for Quantum Eyeglasses (from database)
const QUANTUM_EYEGLASSES_PRODUCT_ID = '2bb424e2-fc60-4598-aefa-975b79f579b7';

const DEFAULT_REGULAR_PRICE = 285600;
const DISCOUNTED_PRICE = 285600;

function Testimonials({ className }: { className?: string }) {
  const items = [
    {
      text: 'After 30 years of glaucoma, doctors declared me free. I can see clearly again!',
      author: 'Azuka — Lagos'
    },
    {
      text: 'My right eye was closed for decades. After wearing these glasses for a few weeks, it opened!',
      author: 'Moses — Benin'
    },
    {
      text: 'I had cataracts and could barely read my Bible. Now I see without surgery.',
      author: 'Mama Okojie — Lagos'
    }
  ];
...
export default function OrderQuantumEyeglassesPage() {
  ...
  const loadProduct = useCallback(async () => {
    try {
      ...
      try {
        ...
        const match = list.find(p => p.id === QUANTUM_EYEGLASSES_PRODUCT_ID) || 
                     list.find(p => p.name && p.name.toLowerCase().includes('eyeglasses'));
        if (match) {
          setProducts([match]);
          setProductError(null);
          return;
      ...
      const fallbackProduct: Product = {
        id: QUANTUM_EYEGLASSES_PRODUCT_ID,
        name: 'Quantum Energy Eyeglasses',
        description: 'Natural vision restoration with Quantum Energy. Safe, effective relief from glaucoma, cataracts, and eye strain.',
        price: DISCOUNTED_PRICE,
        images: ['/quantum-eyeglasses/sunglasses_.jpg'],
        stock: 100,
        category_id: 'quantum-eyeglasses',
        isActive: true,
        featured: true,
        metadata: { 
          tags: ['quantum', 'eyeglasses', 'vision', 'healing']
        },
  ...
  const productImage = product?.images?.[0] || '/quantum-eyeglasses/sunglasses_.jpg';
  const heroImage = '/quantum-eyeglasses/sunglasses_.jpg';
  ...
  return (
    ...
    <main className="min-h-screen w-full bg-white text-black font-sans">
      <Head>
        <title>Order Quantum Energy Eyeglasses — Coach Amara</title>
        <meta name="description" content="Order Quantum Energy Eyeglasses — ₦285,600. Natural vision restoration. Safe, effective relief from glaucoma, cataracts, and eye strain." />
      </Head>
      ...
      <section className="w-full relative overflow-hidden bg-gradient-to-br from-amber-50 via-white to-amber-100">
        <div className="relative z-10 w-full mx-auto py-20 px-6">
          <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
            <div className="bg-amber-400 text-black px-8 py-3 rounded-full text-xl md:text-2xl font-extrabold mb-4 shadow-xl">See Clearly Again</div>
            <h1 className="text-gray-900 text-5xl md:text-7xl font-extrabold leading-tight mb-6 font-playfair">Quantum Energy Eyeglasses</h1>

            <div className="bg-gradient-to-r from-amber-500 to-yellow-500 text-white px-8 py-4 rounded-2xl text-2xl md:text-3xl font-extrabold italic mb-8 shadow-xl">Natural Vision Restoration</div>

            <div className="w-full flex justify-center mb-8">
              <button
                onClick={() => {
                  try {
                    trackMeta('InitiateCheckout', { value: DISCOUNTED_PRICE, currency: 'NGN', content_ids: [QUANTUM_EYEGLASSES_PRODUCT_ID], content_type: 'product' });
                  } catch {}
            ...
            <div className="w-full max-w-3xl mb-8">
              <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-2xl border-4 border-amber-400">
                <Image 
                  src={heroImage} 
                  alt="Quantum Energy Eyeglasses" 
                  fill 
            ...
            <div className="bg-amber-500 rounded-2xl px-8 py-5 mb-8 shadow-xl">
              <div className="text-white text-2xl md:text-3xl font-extrabold">₦285,600</div>
              <div className="text-white/90 text-sm md:text-base font-semibold mt-1">Lifetime Use • No Maintenance</div>
            </div>

            <p className="max-w-3xl text-gray-800 text-xl md:text-2xl font-semibold mb-8 leading-relaxed">Safe, effective relief from glaucoma, cataracts, and eye strain. Quantum Energy Eyeglasses support your eyes' natural ability to repair themselves — naturally and without surgery.</p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="order-1 md:col-span-2">
            <h2 className="text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight mb-6 font-playfair">Why Quantum Energy Eyeglasses Work</h2>
            <p className="text-2xl md:text-3xl font-bold text-amber-700 mb-8 leading-relaxed">The Power of Quantum Energy for Your Eyes</p>

            <ul className="space-y-6 mb-10">
              <li className="flex items-start gap-4 text-gray-800">
                <span className="mt-1 text-amber-500 text-3xl font-bold">✓</span>
                <span className="text-xl md:text-2xl font-bold">Improve micro-circulation around the eyes</span>
              </li>
              <li className="flex items-start gap-4 text-gray-800">
                <span className="mt-1 text-amber-500 text-3xl font-bold">✓</span>
                <span className="text-xl md:text-2xl font-bold">Reduce eye pressure and strain caused by glaucoma and cataracts</span>
              </li>
              <li className="flex items-start gap-4 text-gray-800">
                <span className="mt-1 text-amber-500 text-3xl font-bold">✓</span>
                <span className="text-xl md:text-2xl font-bold">Activate the optic nerves and restore energy flow to the eyes</span>
              </li>
              <li className="flex items-start gap-4 text-gray-800">
                <span className="mt-1 text-amber-500 text-3xl font-bold">✓</span>
                <span className="text-xl md:text-2xl font-bold">Protect against harmful blue light and UV rays</span>
              </li>
              <li className="flex items-start gap-4 text-gray-800">
                <span className="mt-1 text-amber-500 text-3xl font-bold">✓</span>
                <span className="text-xl md:text-2xl font-bold">Boost concentration and relieve headaches from eye fatigue</span>
              </li>
              <li className="flex items-start gap-4 text-gray-800">
                <span className="mt-1 text-amber-500 text-3xl font-bold">✓</span>
                <span className="text-xl md:text-2xl font-bold">Safe, natural, and suitable for all ages</span>
              </li>
            </ul>
            ...
            <div className="relative inline-flex items-center bg-amber-400 text-black px-8 py-6 rounded-r-2xl rounded-l-lg shadow-2xl">
              <div className="pr-6">
                ...
                <div className="text-2xl md:text-3xl font-extrabold">Get Quantum Energy Eyeglasses for ₦285,600</div>
                    ...
                    <div className="bg-gradient-to-br from-amber-50 to-white p-4 rounded-xl border-2 border-amber-200">
                      <div className="flex items-start gap-3 mb-3">
                        <div className="w-20 h-20 relative rounded-lg overflow-hidden border-2 border-amber-300">
                          <Image src={productImage} alt={product?.name || 'Quantum Energy Eyeglasses'} fill className="object-contain bg-white" />
                        </div>
                        <div>
                          <div className="font-extrabold text-base text-gray-900">{product?.name || 'Quantum Energy Eyeglasses'}</div>
                          <div className="text-xs text-gray-600 font-semibold mt-1">Natural vision restoration technology</div>
                        </div>
                      </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-white rounded-3xl p-10 shadow-2xl border-4 border-white flex flex-col items-center gap-6 text-center">
            ...
            <div className="flex-1">
              <div className="bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 bg-clip-text text-transparent font-extrabold text-5xl md:text-6xl mb-4 leading-tight">Ready to See Clearly Again?</div>
            ...
            <div>
              <button 
                onClick={() => {
                  const section = document.getElementById('shipping-section');
                  if (section) {
                    // For mobile and desktop: scroll to shipping section with offset for better visibility
                    const yOffset = typeof window !== 'undefined' && window.innerWidth < 768 ? -20 : -100;
                    const y = section.getBoundingClientRect().top + window.pageYOffset + yOffset;
                    window.scrollTo({ top: y, behavior: 'smooth' });
                  }
